...
<CodeGroup>
```tsx twoslash
import { co, CoMap, ID } from "jazz-tools";
...
<CodeGroup>
```tsx twoslash
import { co, CoMap, ID, Account } from "jazz-tools";
...
<CodeGroup>
```ts twoslash
import { co, CoMap, Account } from "jazz-tools";
// ---cut---
// schema.ts
export class BubbleTeaOrder extends CoMap {
  name = co.string;
...
import * as React from "react";
import { useCoState, useAccount } from "jazz-react";
import { BubbleTeaOrder, DraftBubbleTeaOrder } from "schema";
